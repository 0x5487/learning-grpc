...
func (*HelloRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_helloworld_23abc991f24f69d8, []int{0}
}
...
func (*HelloReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_helloworld_23abc991f24f69d8, []int{1}
}
...
func init() {
	proto.RegisterFile("helloworld/helloworld.proto", fileDescriptor_helloworld_23abc991f24f69d8)
}

var fileDescriptor_helloworld_23abc991f24f69d8 = []byte{
